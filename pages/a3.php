...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
	  ...
	  <img class="imgl borderedbox inspace-5" src="../images/demo/art/a.jpg" alt="">
	  
     <p>Since most of us spend majority of our time at work, it is given that the workplace environment plays an important role in our physical and mental health. A negative working environment is generally associated with depression and anxiety, harassment and bullying among people in their prime years.</p> 
					<b>Risks to Mental Health at Workplace</b>
<p>
<ul class="work-details-list">
<li><strong>Workplace stress -</strong> It is caused due to rigid working hours and also when employees are unclear about the goals they have to achieve.</li>
<li><strong>Lack of support -</strong> Colleagues often don’t support each other in decision making, there is poor communication among them. Even unproductive management practices and leadership qualities affect the employees. </li>
<li><strong>Inadequate health and safety policies –</strong> Managers and leaders often neglect the health and safety of their employees.</li>
</ul>
</p>
<img class="imgr borderedbox inspace-5" src="../images/demo/art/b.jpg" alt="">

<b>Can we create a Mentally Healthy Workspace Environment?</b>
 <p>In reality, creating a mentally healthy workspace environment is not as difficult as it seems. Good mental health is the key requirement for workplace wellness.
 <ul class="work-details-list">
<li>Mental health should be promoted; there should be awareness and employees and employers should be able to talk freely about it.</li>
<li>If a person has taken some measures to improve his mental health, others should support him. They could even take inspiration from him, and work on their own mental health. </li>
<li>Counseling sessions could be organized for the employees letting them know where they could find help, if required.</li>
<li>Small policies like flexible working hours, availability of healthy food, paid leaves etc. could help a lot.</li>
</ul>
 </p>
