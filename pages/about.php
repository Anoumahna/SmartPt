...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
	  ...
	  <img class="imgr borderedbox inspace-5" src="../images/demo/33.jpeg" alt="">
	  
      <p>
						It is normal to visit a doctor in case there is a sprain in your leg, but many hesitate to do the same in case of issues like depression.
					</p>

					<p>
						
                     MOOD is a platform for people to know that health and medical care don't just limit to the social well-being of a person. Mental health and the emotional well-being of a person are equally important. 

					</p>
                      
					<p>
						Mental health issues carry a social stigma with them. Most families where a person is suffering from mental health issues do not open up about their suffering till it is very late. Poor health-seeking behaviour along with lack of knowledge about the availability of services prevents them from seeking timely care. 
					</p>
					
					<img class="imgl borderedbox inspace-5" src="../images/demo/6.jpg" alt="">

					<p>
						Our project aims to create awareness about the importance of mental health in a person's life and let a person analyze his/her emotions, which in turn lets them know if they need to consult a specialist or seek help from other resources. 
					</p>

					<p>
						We also provide free tests for the user to take for different aspects of mental health like personality, EQ, ADHD, etc. to further help the cause.
