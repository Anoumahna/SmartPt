       ...
       <div class="content"> 
        ...
        <div class="row">
			...
			<div style="float: left;clear: none;">
				...
				<label style="float:left;clear: none;display: block;" for="0"> Yes, somewhat or a little</label>
            </div>
			<div style="float: left;clear: none;">
               	<input style="float: left;clear: none;" name="radio-opt1" value="2" id="three" type="radio" class="radio"/>
				<label style="float:left;clear: none;display: block;" for="0"> Yes, moderately to quite a lot</label>
            </div>
			<div style="float: left;clear: none;">
               	<input style="float: left;clear: none;" name="radio-opt1" value="3" id="four" type="radio" class="radio"/>
				<label style="float:left;clear: none;display: block;" for="0"> Yes, very much</label>
			</div>
             </form>
			<br><br>                   
				...
				<div style="float: left;clear: none;">
					...
					<label style="float:left;clear: none;display: block;" for="0"> Yes, very much</label>
						...
						<div class="submit-test">
                            	<a href="#" class="submit_adhd_btn btn" onclick="myFunction()" style="margin:10px;">Submit</a>
                         </div>
                    </div>
		...
		var str1="0-5, Low Level of Experiences Associated With ADHD";
		var str2="6-13, Significant Level of Experiences Associated With ADHD, But Mitigating Factors";
