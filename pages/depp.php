...
When answering the questions think back over the last ten to fourteen days and reflect on the relevance of each statement for your personal experience.</p>
                <div class="row">
                    <div class="col-sm-8 col-md-9">
                    	<form name="frm1" class="qustion_main" method="post">
                            <div class="qustion_box">
                                <div class="qustion">1. I do things slowly.</div>
                                <div class="ans">
                                	<div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="one" value="0" type="radio">Not at all</label>
                                    </div>
                                    <div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="two" value="1" type="radio">Just a little</label>
                                    </div>
                                    <div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="three" value="2" type="radio">Somewhat</label>
                                    </div>
                                    <div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="four" value="3" type="radio">Moderately</label>
                                    </div>
									<div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="five" value="4" type="radio">Quite a lot</label>
                                    </div>
									<div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="six" value="5" type="radio">Very much</label>
                                    </div>
                                </div>
                            </div>
                        </form>
						<form name="frm2" class="qustion_main" method="post">
                            <div class="qustion_box">
                                <div class="qustion">2. My future seems hopeless.</div>
                                <div class="ans">
                                	<div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="seven" value="0" type="radio">Not at all</label>
                                    </div>
                                    <div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="eight" value="1" type="radio">Just a little</label>
                                    </div>
                                    <div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="nine" value="2" type="radio">Somewhat</label>
                                    </div>
                                    <div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="ten" value="3" type="radio">Moderately</label>
                                    </div>
									<div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="eleven" value="4" type="radio">Quite a lot</label>
                                    </div>
									<div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="twelve" value="5" type="radio">Very much</label>
                                    </div>
                                </div>
                            </div>
                        </form>
						<form name="frm3" class="qustion_main" method="post">
                            <div class="qustion_box">
                                <div class="qustion">3. It is hard for me to concentrate on reading or other tasks.</div>
                                <div class="ans">
                                	<div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="thirt" value="0" type="radio">Not at all</label>
                                    </div>
                                    <div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="fourt" value="1" type="radio">Just a little</label>
                                    </div>
                                    <div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="fift" value="2" type="radio">Somewhat</label>
                                    </div>
                                    <div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="sixt" value="3" type="radio">Moderately</label>
                                    </div>
									<div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="sevent" value="4" type="radio">Quite a lot</label>
                                    </div>
									<div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="eightt" value="5" type="radio">Very much</label>
                                    </div>
                                </div>
                            </div>
                        </form>
						<form name="frm4" class="qustion_main" method="post">
                            <div class="qustion_box">
                                <div class="qustion">4. The pleasure and joy has gone out of my life.</div>
                                <div class="ans">
                                	<div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="nint" value="0" type="radio">Not at all</label>
                                    </div>
                                    <div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="twenty" value="1" type="radio">Just a little</label>
                                    </div>
                                    <div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="tone" value="2" type="radio">Somewhat</label>
                                    </div>
                                    <div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="ttwo" value="3" type="radio">Moderately</label>
                                    </div>
									<div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="tthree" value="4" type="radio">Quite a lot</label>
                                    </div>
									<div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="tfour" value="5" type="radio">Very much</label>
                                    </div>
                                </div>
                            </div>
                        </form>
						<form name="frm5" class="qustion_main" method="post">
                            <div class="qustion_box">
                                <div class="qustion">5. I have difficulty making decisions.</div>
                                <div class="ans">
                                	<div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="tfive" value="0" type="radio">Not at all</label>
                                    </div>
                                    <div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="tsix" value="1" type="radio">Just a little</label>
                                    </div>
                                    <div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="tseven" value="2" type="radio">Somewhat</label>
                                    </div>
                                    <div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="teight" value="3" type="radio">Moderately</label>
                                    </div>
									<div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="tnine" value="4" type="radio">Quite a lot</label>
                                    </div>
									<div class="ans-slide">
                                    	<label class="label_radio"><input name="radio-opt" id="thirty" value="5" type="radio">Very much</label>
                                    </div>
                                </div>
                            </div>
                        </form>
		...
		var str1="0–9, No depression likely.";
		var str2="10–21, Possible symptoms that may be due to depression or other medical issues.";
		var str3="22–35, Mild to Moderate Depression.";
		var str4="36–53, Moderate to Severe Depression.";
		var str5="54 and up Severely Depressed.";
