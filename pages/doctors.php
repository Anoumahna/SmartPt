    ...
    <header id="header" class="hoc clear"> 
      ...
      <nav id="mainav" class="fl_right">
        <ul class="clear">
		  ...
		  <li class="active"><a href="doctors.php">Doctors Near Me</a></li>
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
   <center><h1>Our Counsellors</h1></center>
  <p> We believe that there is nothing in this world that can torment us more than our own thoughts, thus we decided to reach out to all those who need
   our help. We have planned a five day sessional activities with our counsellors free of cost.
  Through these activities we try to help  you gain back your confidence.
 Remeber that we are there!!</p>
 <center>



  		<script type="text/javascript" src="https://secure.skypeassets.com/i/scom/js/skype-uri.js"></script>
<span class="skype-button rectangle" data-contact-id="live:50a05b301c61c44d"></span>
